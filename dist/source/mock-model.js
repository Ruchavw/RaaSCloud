...
const cloud_recovery_1 = require("./components/cloud-recovery");
// FSMs
...
// Example fault handler in mock model
function handleSensorFault(sensorData) {
    console.warn("🚨 Sensor fault detected:", sensorData);
    // BFT Cloud Recovery Integration
    (0, cloud_recovery_1.invokeCloudBFTRecovery)(sensorData)
        .then(() => {
        console.log("✅ Cloud BFT recovery sequence complete.");
    })
        .catch((err) => {
        console.error("❌ Cloud BFT recovery failed:", err);
    });
}
